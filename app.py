...
with st.sidebar:
    selected=option_menu('Multiple Disease Detection System',['Welcome','Pneumonia classification'
        'Cancer','Diabetes','Heart','Kidney','Liver','Parkinsons'],
        icons=['Lungs','book','bookmark-check','bi-app-indicator','heart','file-bar-graph','activity','bi-person'],
        default_index=0)
...
if selected=='Pneumonia classification':
   st.title('Pneumonia classification Test')    
   # set title
